...
import { cn, toCST } from '@/lib/utils'
              ...
              {!isSmall && (
                <div className="text-xs flex text-start w-full flex-col gap-1 overflow-auto scroll-container">
                  {events
                    ...
                    .map((event) => {
                      const startDate = toCST(new Date(event.startDateTime))
                      const endDate = toCST(new Date(event.endDateTime))
                      ...
                      return (
                        ...
                        >
                          ...
                          {isMediumLg && <div className="h-2 w-full" />}
                        </Badge>
                      )
                    })}
                </div>
